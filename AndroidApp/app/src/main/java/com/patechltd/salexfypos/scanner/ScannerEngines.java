...
public final class ScannerEngines {
    ...
    // public static final String ENGINE_OPENCV_QR = "opencv_qr";   // COMMENTED OUT (OpenCV removed)
    ...
    public static DecodeEngine create(Context context) {
        ...
        // if (ENGINE_OPENCV_QR.equals(id)) return new OpenCVQREngine();   // COMMENTED OUT (OpenCV removed)
        if (ENGINE_ZBAR.equals(id)) return new ZBarEngine();
